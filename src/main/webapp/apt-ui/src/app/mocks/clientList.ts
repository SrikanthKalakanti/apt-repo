...
export const CLIENTDETAILS: ClientData[] = [
    ...
    { clientId: 3, name: 'Manoj Kumar', status: 'Service', address: 'ZXY', mobile: 123456789, email: 'sampath.gambheerrao@gmail.com', lineofactivity: 'Service', dateoffirstditributionoftermloan: '01/20/2018'}
];
